...
// If the the button with the name of 'submitform' is set do perform the following procedure
				...
				// $run will check the query and the connection of DB
					...
					if($user_found == false)
					{
						...
						header("location: loginDriver.php?success=".urldecode("Error"));
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="styleloginDriver.css">
...
<body>
	<div class="login">
		...
		<p id = "demo"></p>
		<form action="loginDriver.php" method="post">
			...
			<script>
				...
				<p> Don't have an Account. <a href="signupDriver.php" > Create a new one. </a> <!-- link to html -->
				</form>
			</div>
		</body>
		</html>